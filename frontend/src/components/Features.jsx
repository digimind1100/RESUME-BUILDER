            ...
            <main className="features-content">
                ...
                <section className="features-section">
                    ...
                    <div className="features-grid">
                        <Feature title="AI-Powered Content" desc="Get smart skill and work-experience suggestions based on your job title." />
                        <Feature title="Live Resume Preview" desc="See changes instantly while editing — no refresh required." />
                        <Feature title="Professional Templates" desc="Clean, modern, ATS-friendly resume templates trusted by recruiters." />
                        <Feature title="PDF Export" desc="Download high-quality, print-ready PDF with page numbers." />
                        <Feature title="QR Resume Support" desc="Generate QR-based resumes for quick profile sharing." />
                        <Feature title="Privacy First" desc="Your data stays private. No sharing, no selling." />
                    </div>
                </section>
