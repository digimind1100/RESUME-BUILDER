...
Profile: ${profileLink}
  ...
  const roleData = {
    pilot: {
      ...
      summary:
        "Highly skilled commercial airline pilot with 4,500+ total flight hours...",
      exp1Title: "Captain — Boeing 737 (NG/MAX)",
      exp1Company: "SkyWings Airlines — International & Domestic Operations",
      exp1Dates: "2019 – Present",
      exp1Bullets: [
        "Operate scheduled long-haul and regional flights...",
        "Execute takeoff, climb, cruise...",
      ],
      exp2Title: "First Officer — Airbus A320 Family",
      exp2Company: "BlueJet Airways — Regional Fleet",
      exp2Dates: "2014 – 2019",
      exp2Bullets: [
        "Assisted the captain in flight operations...",
        "Executed takeoffs and landings...",
      ],
      highlights: [
    ...
    // OTHER ROLES OMITTED HERE FOR BREVITY — KEEP YOUR EXISTING DATA
    cabin: {
    ...
    <div className="av-wrapper">
      ...
      <div className="av-qr-form">
        ...
        <div className="av-qr-row">
          ...
          <input placeholder="Portfolio / Profile Link" value={profileLink} onChange={(e) => setProfileLink(e.target.value)} />
        </div>

        <button className="av-qr-btn" onClick={handleGenerateQR}>Create QR Code</button>
      </div>
          ...
          <header className="av-header">
            <div className="av-header-left">
              ...
              <div className="av-header-text">
                <h1 className="av-name" contentEditable={isEditable} suppressContentEditableWarning>
                  ALEXANDER MORGAN
                </h1>

                <p className="av-role" contentEditable={isEditable} suppressContentEditableWarning>
            ...
            <div className="av-header-right">
              <div className="av-qr-block">
                ...
                <p className="av-qr-text" contentEditable={isEditable} suppressContentEditableWarning>
          ...
          <div className="av-body">
            ...
            <main className="av-main">
              ...
              <section className="av-section">
                <h2 className="av-section-title" contentEditable={isEditable}>PROFESSIONAL SUMMARY</h2>

                <p className="av-section-text" contentEditable={isEditable}>
                  {activeData.summary}
                </p>
              </section>
              ...
              {/* EXPERIENCE */}
              <section className="av-section">
                <h2 className="av-section-title" contentEditable={isEditable}>EXPERIENCE</h2>

                {/* JOB 1 */}
                <div className="av-job">
                  <div className="av-job-header">
                    <div>
                      <p className="av-job-title" contentEditable={isEditable}>
                        {activeData.exp1Title}
                      </p>
                      <p className="av-job-company" contentEditable={isEditable}>
                        {activeData.exp1Company}
                      </p>
                    </div>

                    <p className="av-job-dates" contentEditable={isEditable}>
                  ...
                  <ul className="av-job-list">
                    {activeData.exp1Bullets.map((item, idx) => (
                      <li key={idx} contentEditable={isEditable}>{item}</li>
                    ))}
                  </ul>
                </div>
              ...
              <section className="av-section av-section-last">
                <h2 className="av-section-title" contentEditable={isEditable}>
                  KEY HIGHLIGHTS
                </h2>
            ...
            <aside className="av-sidebar">
              ...
              <section className="av-side-section">
                ...
                <ul className="av-side-list">
                  <li contentEditable={isEditable}>✉️ alex.morgan@mail.com</li>
                  <li contentEditable={isEditable}>📞 +1 (555) 214-8790</li>
                  <li contentEditable={isEditable}>📍 New York, USA</li>
                  <li contentEditable={isEditable}>🌐 linkedin.com/in/alexmorgan</li>
                </ul>
              </section>
              ...
              <section className="av-side-section">
                ...
                <div className="av-side-qr-box">
                  ...
                  <p className="av-side-qr-text" contentEditable={isEditable}>
              ...
              <section className="av-side-section">
                ...
                <ul className="av-side-list">
                  <li contentEditable={isEditable}>Safety & Compliance</li>
                  <li contentEditable={isEditable}>Crew Resource Management</li>
                  <li contentEditable={isEditable}>Emergency Procedures</li>
                  <li contentEditable={isEditable}>Communication</li>
                </ul>
              </section>
              ...
              <section className="av-side-section">
                ...
                <ul className="av-side-list">
                  <li contentEditable={isEditable}>Valid Passport</li>
                  <li contentEditable={isEditable}>Medical Certificate</li>
                  <li contentEditable={isEditable}>Safety Training</li>
                </ul>
              </section>
              ...
              <section className="av-side-section">
                ...
                <ul className="av-side-list">
                  <li contentEditable={isEditable}>English — Fluent</li>
                  <li contentEditable={isEditable}>Spanish — Conversational</li>
